...
function peg$parse(input, options) {
  ...
  var peg$f4 = function(left, op, right) { return {kind: "op", left: left, op: op, right: right}; };
  ...
  function peg$parsestart() {
    ...
    s0 = peg$currPos;
    s1 = peg$parsenot_formula();
    s2 = [];
    s3 = peg$currPos;
    s4 = peg$parseformula();
    if (s4 !== peg$FAILED) {
      s5 = peg$parsenot_formula();
      s4 = [s4, s5];
      s3 = s4;
    } else {
      peg$currPos = s3;
